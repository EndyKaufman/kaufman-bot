...
import { HOST_TYPE, PROJECT_BOT_INGRESS_PATH, PROJECT_BOT_INGRESS_REWRITE_TARGET, PROJECT_DOMAIN, PROJECT_NAME } from '../../constants';
                    ...
                    paths: [
                        {
                            ...
                            backend: {
                                serviceName: `${PROJECT_NAME}-bot-service`,
                                servicePort: 5000,
                            },
                        },
                    ],
