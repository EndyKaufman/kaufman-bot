...
# [2022-02-17 21:42] Publish all the libraries in Telegram bot on NestJS to the npm registry
...
Add build section
_libs/core/server/project.json_
...
![Add build section](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/4k6lg6m7my29j8zjm5cy.png)

### Update package.json

You should collect all used imports and add them to the dependencies section.

_libs/core/server/package.json_
...
```json
{
  ...
  "license": "MIT",
  "author": "EndyKaufman <admin@site15.ru>",
  "keywords": ["kaufman-bot", "nx", "nests", "telegram", "core"],
  "bugs": {
    "url": "https://github.com/EndyKaufman/kaufman-bot/issues"
  },
  "homepage": "https://github.com/EndyKaufman/kaufman-bot",
...
Navigate to https://www.npmjs.com/settings/<YOUR_NAME>/tokens

Click to create token
![Click to create token](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/7epl90uzmtw6h1nawfr3.png)

Click to generate
![Click to generate](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/th6czc66ig49v317pd6n.png)

After that you see generated token
![After that you see generated token](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/s1s6umua8p2rjucl72zm.png)

### Append token to github envs

Go to https://github.com/<YOU_NAME>/<YOU_REPOSITORY>/settings/secrets/actions

Create common environment variable
![Create common environment variable](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/ppgza12v9ypktnshtr31.png)

In the next post, I will add schematics for create application from command line...

#kaufmanbot #nestjs #npm #publish

# [2022-04-22 14:58] Add schematics for create empty kaufman-bot applications and library in Telegram bot on NestJS
...
\_libs/schematics/src/generators/application/files/main.ts\_\_tmpl\_\_\_
...
\_libs/schematics/src/generators/application/files/app/app.service.ts\_\_tmpl\_\_\_
...
\_libs/schematics/src/generators/application/files/app/app.module.ts\_\_tmpl\_\_\_
...
\_libs/schematics/src/generators/library/files/service/src/lib/\_\_fileName\_\_.service.ts\_\_tmpl\_\_\_
...
\_libs/schematics/src/generators/library/files/common/src/lib/\_\_fileName\_\_.module.ts\_\_tmpl\_\_\_
...
_libs/schematics/src/generators/init/lib/add-custom.ts_
...
_libs/schematics/src/generators/init/lib/index.ts_
...
_libs/schematics/src/utils/versions.ts_
...
_libs/schematics/src/generators/init/lib/add-dependencies.ts_
...
_libs/schematics/src/generators/application/application.ts_
...
Update init helper
_libs/schematics/src/generators/init/init.ts_
...
Create public.ts
_libs/schematics/src/public.ts_
...
Update package.json
_libs/schematics/package.json_
...
_libs/schematics/project.json_
...
_libs/schematics/src/generators/init/lib/normalize-options.ts_
...
_libs/schematics/src/generators/init/schema.d.ts_
...
_libs/schematics/src/generators/init/schema.json_
...
_libs/schematics/src/generators/application/lib/normalize-options.ts_
...
_libs/schematics/src/generators/application/schema.d.ts_
...
_libs/schematics/src/generators/application/schema.json_
...
_libs/schematics/src/generators/library/lib/add-exports-to-barrel.ts_
...
Update create files
_libs/schematics/src/generators/library/lib/create-files.ts_
...
Update options
_libs/schematics/src/generators/library/lib/normalize-options.ts_
...
_libs/schematics/src/generators/library/schema.d.ts_
