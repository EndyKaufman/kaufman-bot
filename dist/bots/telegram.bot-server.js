...
class TelegramBotServer extends base_bot_server_1.BaseBotServer {
    constructor(name) {
        ...
        this.plugins.push(new scraper_plugin_1.ScraperPlugin(this.env('BOT_NAME_ALIASES', 'bot').split(','), this.env('SCRAPER_FORISMATIC_URI'), this.env('SCRAPER_FORISMATIC_TIMEOUT', 10000), this.env('SCRAPER_FORISMATIC_CONTENT_SELECTOR'), this.env('SCRAPER_FORISMATIC_CONTENT_LENGTH', 1000), 'windows-1251', this.env('SCRAPER_FORISMATIC_SPY_WORDS', 'quote').split(','), this.env('SCRAPER_FORISMATIC_WHAT_CAN_I_DO_EN'), this.env('SCRAPER_FORISMATIC_WHAT_CAN_I_DO_RU')));
        ...
        this.plugins.push(new scraper_plugin_1.ScraperPlugin(this.env('BOT_NAME_ALIASES', 'bot').split(','), this.env('SCRAPER_PING_URI'), this.env('SCRAPER_PING_TIMEOUT', 10000), this.env('SCRAPER_PING_CONTENT_SELECTOR'), this.env('SCRAPER_PING_CONTENT_LENGTH', 1000), null, this.env('SCRAPER_PING_SPY_WORDS', 'ping').split(','), this.env('SCRAPER_PING_WHAT_CAN_I_DO_EN'), this.env('SCRAPER_PING_WHAT_CAN_I_DO_RU')));
