...
export declare class ScraperPlugin implements IPlugin {
    ...
    constructor(bot: TelegramBot, telegramBotNameAliases: string[], scraperUri: string, scraperTimeout: string, scraperContentSelector: string, scraperContentLength: number, scraperSpyWords: string[]);
